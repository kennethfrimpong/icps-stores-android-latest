...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String ongissue = "CREATE TABLE " + ongoingIssueTABLE + " ("
                + ongoingIssueID + " INTEGER PRIMARY KEY, "
    ...
    public void addToOngoingIssue(Integer ID, String productName, String productDesc, Integer productQuantity, String productStore, String productLocation, String unit) {
    ...
    public void deleteFromOngoingIssueTable(Integer id){
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public Integer checkOngoingIssueItemQuantity(Integer id){
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public void syncStaffTable(Integer staffiD, String firstName, String middleName, String lastName, String type, String department) {
